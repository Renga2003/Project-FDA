...
* The original package name 'com.fooddelivery.food delivery application' is invalid and this project uses 'com.fooddelivery.food.delivery.application' instead.
